  ...
  <div class="terms-and-condition">
    <div class="container px-3">
      ...
      <p>
        ...
        use of FUTURE Medan's Website, located at gotoba.surge.sh.
      </p>
      <br>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use gotoba if you do not agree to take
      ...
      <p>
        ...
        our website. Some of our affiliate/advertising partners may also
        use cookies.
      </p>
      ...
      <p>
        ...
        gotoba for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        FUTURE Medan does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views
        and opinions of FUTURE Medan,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views
        and opinions. To the extent permitted by applicable laws, FUTURE
        Medan shall not be liable for the Comments or for any liability,
      ...
      <br>
      <p>
        FUTURE Medan reserves the right to monitor all Comments and to
      ...
      <br>
      <p>
        You hereby grant FUTURE Medan a non-exclusive license to use,
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of FUTURE Medan;
      ...
      <p>
        ...
        sending an e-mail to FUTURE Medan. Please include your name, your
      ...
      <br>
      <p>
        No use of FUTURE Medan's logo or other artwork will be allowed for
